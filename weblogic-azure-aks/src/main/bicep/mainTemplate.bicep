...
module autoGeneratedSSLCert './_azure-resoruces/_keyvault/_keyvaultWithNewCert.bicep' = if (enableAppGWIngress && appGatewayCertificateOption != const_appGatewaySSLCertOptionHaveCert) {
