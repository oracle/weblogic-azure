...
module autoGeneratedSSLCert './modules/_azure-resoruces/_autoGeneratedPfxCertandSaveinKeyvault.bicep' = if (enableAppGWIngress && appGatewayCertificateOption != const_appGatewaySSLCertOptionHaveCert) {
